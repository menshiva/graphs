...
DECLARE_STATS_GROUP(TEXT("GRAPHS_PERF_ENTITY_STORAGE"), STATGROUP_GRAPHS_PERF_ENTITY_STORAGE, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("GRAPHS_PERF_GRAPHS_RENDERER"), GRAPHS_PERF_GRAPHS_RENDERER, STATCAT_Advanced);
